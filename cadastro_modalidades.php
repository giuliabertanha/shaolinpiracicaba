...
$sql = "SELECT modalidades.nome AS 'Modalidade', GROUP_CONCAT(usuarios.nome SEPARATOR ', ') AS 'Professores' FROM modalidades
        INNER JOIN usuarios ON usuarios.id = modalidades.id_professor1 OR usuarios.id = modalidades.id_professor2
...
<head>
    ...
    <title>Shaolin Piracicaba | Cadastro de modalidades</title>
</head>
<body>
    <header>
    ...
    <main class="d-flex flex-column align-items-center">
		<h2 class="text-uppercase mt-4 mb-3 text-center"><b>Modalidades</b></h2>  
              ...
              <?php
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td><a href='#'>" . htmlspecialchars($row["Modalidade"]) . "</a></td>";
                        echo "<td class='w-50'>" . htmlspecialchars($row["Professores"]) . "</td>";
                        echo "</tr>";
                    }
                } else {
        ...
        <div class="d-flex w-75 mt-2">
        	<a class="btn text-uppercase w-50 ms-0 btn_verde" href="incluir_modalidade.php">Incluir</a>
